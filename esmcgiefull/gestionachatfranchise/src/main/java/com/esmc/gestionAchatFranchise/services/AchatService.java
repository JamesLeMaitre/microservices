...
public class AchatService implements AchatServiceInterface {
       ...
       switch (stage){
           ...
           case 2:
            //commune
               ...
               if(cantonImp.getCountFreeCantonByCommune(idFranchise)>0 || cantonImp.getCountBuyCantonByCommune(idFranchise) >=minFranchise){
                   return false;
               }
           ...
           case 3:
            //prefecture
               ...
               int countBuyChildCommune = communeImp.getCountBuyCommuneByPrefecture(idFranchise);
               if(countFreeChildCommune>0 || countBuyChildCommune >= minFranchise){
                   return false;
               }
            ...
            //region
                ...
                int countBuyChildPrefecture = prefectureImp.getCountBuyPrefectureByRegion(idFranchise);
                if(countFreeChildPrefecture>0 || countBuyChildPrefecture>minFranchise){
                    return false;
                }
            ...
            //pays
                ...
                int countBuyChildRegion = regionImp.getCountBuyRegionByPays(idFranchise);
                if(countFreeChildRegion>0 || countBuyChildRegion>=2){
                    return false;
                }
           ...
           case 6 :
            //zonemonetaie
               ...
               int countBuyChildPays = paysImp.getCountBuyPaysByZoneMonnetaire(idFranchise);
               System.out.println(countFreeChildPays);
               if(countFreeChildPays>0 || countBuyChildPays>=minFranchise){
                   return false;
               }
           ...
           case 7:
            //continent
               ...
               int countBuyChildZoneMonnetaire = zoneMonnetaireImp.getCountBuyZoneMonnetaireByContinent(idFranchise);
               if(countFreeChildZoneMonnetaire>0 || countBuyChildZoneMonnetaire >= minFranchise){
                   return false;
               }
           ...
           case 8 :
            //monde
               ...
               int countBuyChildContinent = continentInt.getCountBuyContinentByMonde();
    ...
    public Long franchise_flbose_cible (achatFranchiseInput data)
    {
        //Long idFranchise = data.getIdFranchise();
        Long idFranchise = data.getIdFranchiseCible();
        ...
        if(franchiseFlbOseCible == null){
            ...
            //check if available
            return franchiseFlbOseCible.getId();
        }
        ...
        //cible element
        return franchiseFlbOseCible1.getId();
    }



    public Long franchise_flbose_indicateur(achatFranchiseInput data)
    {
        //Long idFranchise = data.getIdFranchise();
        Long idFranchise = data.getIdFranchiseIndicateur();
        Long idFranchiseCanton = data.getIdFranchiseCanton();
        ...
        if(franchiseFlbOseIndicateur == null){
            ...
            //check if available
            return franchiseFlbOseIndicateur.getId();
        }
        System.out.println("-----------------------------------2----------------------------------------------------------------------");
        ...
        System.out.println("------------------------------------4---------------------------------------------------------------------");
        //indicateur  element
        return franchiseFlbOseIndicateur1.getId();
    }
    ...
    public Boolean achat_franchise_decoupage_centre(achatFranchiseInput data) {
        ...
        Long cible = null;
        Long indicateur = null;
        if(stage <7){
            if(CibleElement == true){
                cible = this.franchise_flbose_cible(data);
            }else {
                indicateur = this.franchise_flbose_indicateur(data);
            }
        }
        ...
        switch (stage){
            ...
            case 2:
                ...
                if(CibleElement == true) {
                    franchiseFillChaineValeur1 =   getFirstElement(franchiseFillChaineValeurRepository.getByTypeCibleElement(cible,idFranchise));
                }else {
                    franchiseFillChaineValeur1 =    getFirstElement(franchiseFillChaineValeurRepository.getByTypeIndicateurElement(indicateur,idFranchise));
                }
            ...
            case 3:
                ...
                int countBuyChildFillInstitution = franchiseFillChaineValeurRepository.getCountFillChaineValeurBuyByFillInstitution(idFranchise);
                System.out.println(countFreeChildFillInstitution);
                if (countFreeChildFillInstitution > 0 || countBuyChildFillInstitution >=2) {
                    return false;
                }
                //translation
                // IF payment is ok
            ...
            case 6:
                ...
                int countBuyChildFlbOeChambre = franchiseFlbOeChaineValeurRepository.getCountFlbOeChaineValeurBuyByFlbOeChambre(idFranchise);
                System.out.println(countFreeChildFlbOeChambre >0 || countBuyChildFlbOeChambre>2);
            ...
            case 7:
                ...
                //check all the related child have been bought
                cible = franchiseFlbOseCible.getId();
                int countFreeFlbChildFlbOseCibleInstitution = franchiseFillInstitutionRepository.getCountFreeFlbChildFlbOseCible(cible);
                int countFreeFlbChildFlbOseCibleChambre = franchiseFlbOeChambreRepository.getCountFreeFlbChildFlbOseCible(cible);


                int countBuyFlbChildFlbOseCibleInstitution = franchiseFillInstitutionRepository.getCountBuyFlbChildFlbOseCible(cible);
                int countBuyFlbChildFlbOseCibleChambre = franchiseFlbOeChambreRepository.getCountBuyFlbChildFlbOseCible(cible);

                int sumFreeChildFlbOseCible = countFreeFlbChildFlbOseCibleInstitution + countFreeFlbChildFlbOseCibleChambre;
                int sumBuyChildFlbOseChambre = countBuyFlbChildFlbOseCibleInstitution + countBuyFlbChildFlbOseCibleChambre;
                System.out.println(sumFreeChildFlbOseCible);
                System.out.println(sumBuyChildFlbOseChambre);
                if (sumFreeChildFlbOseCible> 0 || sumBuyChildFlbOseChambre>2) {
                    return false;
                }
                // IF payment is ok
            ...
            case 8 :
                ...
                indicateur = franchiseFlbOseIndicateur.getId();
                int countFreeFlbChildFlbOseIndicateurInstitution = franchiseFillInstitutionRepository.getCountFreeFlbChildFlbOseIndicateur(indicateur);
                int countFreeFlbChildFlbOseIndicateurChambre = franchiseFlbOeChambreRepository.getCountFreeFlbChildFlbOseIndicateur(indicateur);


                int countBuyFlbChildFlbOseIndicateurInstitution = franchiseFillInstitutionRepository.getCountBuyFlbChildFlbOseIndicateur(indicateur);
                int countBuyFlbChildFlbOseIndicateurChambre = franchiseFlbOeChambreRepository.getCountBuyFlbChildFlbOseIndicateur(indicateur);

                int sumFreeChildFlbOseIndicateur = countFreeFlbChildFlbOseIndicateurInstitution + countFreeFlbChildFlbOseIndicateurChambre;
                int sumBuyChildFlbOseIndicateur = countBuyFlbChildFlbOseIndicateurInstitution + countBuyFlbChildFlbOseIndicateurChambre;
                System.out.println(sumFreeChildFlbOseIndicateur);
                System.out.println(sumBuyChildFlbOseIndicateur);
                if (sumFreeChildFlbOseIndicateur> 0 || sumBuyChildFlbOseIndicateur>2) {
                    return false;
                }
    ...
    public Boolean achat_franchise_decoupage_centre_check(achatFranchiseInput data) {
        ...
        switch (stage) {
            ...
            case 2:
                ...
                //check all the related child have been bought
                int countFreeChildFillChaineValeur = franchiseFillChaineDistributionRepository.getCountFillChaineDistributionByFillChaineValeur(idFranchise);
                int countBuyChildFillChaineValeur = franchiseFillChaineDistributionRepository.getCountFillChaineDistributionBuyByFillChaineValeur(idFranchise);
                System.out.println(countFreeChildFillChaineValeur);
                if (countFreeChildFillChaineValeur > 0 || countBuyChildFillChaineValeur >=2) {
                    return false;
                }
